...
//alert(`So then if they cost $3 a day, you owe $${cost.toFixed(2)} `) adding .toFixed will add the decimals needed for coin totals.
...
let g = prompt ("How much does Google pay you per hour?")
alert (`${g}, right?`)

let ama = prompt ("How much does Amazon pay you per hour?")
alert (`${ama}, right?`)

let f = prompt ("And how much does Facebook pay you?")
alert (`${f}, right?`)

let pay = ((g * 6) + (ama * 4) + (f * 10))
